    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-16 mt-20">
          <div>
            <p className="text-[#cfd6e6]/80 text-lg sm:text-xl leading-relaxed">
            ...
            <p className="mt-8 text-[#cfd6e6]/75 text-base sm:text-lg leading-relaxed">
          ...
          >
            <div className="space-y-8">
              <div>
                ...
                <p className="mt-3 text-sm sm:text-base text-[#cfd6e6]/75 leading-relaxed">
